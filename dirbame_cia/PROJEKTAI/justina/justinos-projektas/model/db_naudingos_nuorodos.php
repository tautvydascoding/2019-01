...
function getDoctor($nr){  //vienaskaita, nes ieskai vieno id informacijos;
    $manoSQL = "SELECT * FROM naud_nuorodos_meniu WHERE id = $nr"; //issigalvotas kintamasis, tiesiog stringas, gali bet koki teksta rasyti.
...
function getDoctors($kiekGydytoju=99999){  //daugiskaita, nes ieskai visu;
    $manoSQL = "SELECT * FROM naud_nuorodos_meniu
                        ORDER BY id ASC
