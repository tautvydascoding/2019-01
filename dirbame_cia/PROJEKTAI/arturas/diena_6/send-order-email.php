<?php
  ...
  try {
    ...
    //Recipients
    $mail->setFrom('tomastomsonas1234@gmail.com', 'Projektas.lt');
    ...
    $mail->send();
    echo '<p class="h4 text-center m-3">Užsakymo ir apmokėjimo informacija išsiųsta el. paštu. Ačiū, kad pirkote Projektas.lt</div>';
} catch (Exception $e) {
