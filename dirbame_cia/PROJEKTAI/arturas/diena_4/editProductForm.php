<?php
 ...
 ?>
 <form class="" action="editProduct.php" method="post">
   <p>db id</p>
   <input type="text" name="id" value="<?php echo "{$product['id']}"; ?>" readonly><br>
   <p>Antraštė</p>
...
<hr><a href='productList.php'>Grįžti į prekių sąrašą</a>
