...
<html>
    ...
    <body>
        ...
        echo "Testosteronas pradinis:". $vyras->getTestostKiekis();

        $vyras->setTestostKiekis(5555); // naujas testosterono kiekis

        $vyras->printTestostKiekis(); //paleidzia print f-ja
