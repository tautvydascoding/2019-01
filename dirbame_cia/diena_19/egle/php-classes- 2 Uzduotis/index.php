...
<html>
    ...
    <body>
        ...
        require_once('vyras.php');
          ...
          $darbuotojas1 = new vyras();

          // echo $vyras->setTesto(6080);

          $darbuotojas1->setTesto(3215);
          $darbuotojas1->printTestosteronas();
          $darbuotojas1->printDuomenys();
          $darbuotojas1->printPusryciai2();
