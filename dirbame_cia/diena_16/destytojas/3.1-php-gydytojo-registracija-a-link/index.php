...
<html>
    ...
    <body>
        ...
        <a class="btn bg-success" href='naujasGydytojas.php?vardas=TOMAS&pavarde=TOMAUSKIS'> Kurti Nauja</a>
        <a class="btn bg-danger" href='trintiGydytoja.php?nr=10'> Istrinti</a>
