...
<html>
    ...
    <body>
        ...
        <a href="naujasGydytojas.php?vard=TOMAS&parv=TOMAUSKIS">Kurti Nauja</a> <br />


        <a href="trintiGydytoja.php?vard=TOMAS&parv=TOMAUSKIS">Istrinti gydytoja</a> <br />




        <form class="" action="registracija.php" method="get">
          <input type="text" name="vard" value="" placeholder="name">
          <input type="text" name="parv" value="" placeholder="surname">
