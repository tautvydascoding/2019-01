...
<html>
    ...
    <body>
        ...
        <form class="" action="spausdinti.php" method="get">
          <input type="text" name="vardas" placeholder="vardas">
          <input type="number" name="x" placeholder="skaicius">
          <input type="submit" name="" value="Spausdinti">

        </form>
<hr />

<!-- su a link atspausdina tai, kas as ivedziau URL adrese  -->

<button type="submit" name="button">
<a href="spausdinti.php?vardas=Paulius&x=970">Spausdinti</button>
