...
<html>
    ...
    <body>
        ...
        <hr>
        <form class="" action="doctor.php" method="post">
          <p>Gydytojo ištrynimas pagal id:</p>
          <input type="text" name="nrdel" value="">
          <input type="submit" name="" value="Ištrinti gydytoją">
        </form>
        <hr>
        <form class="" action="doctor.php" method="post">
          <p>Gydytojo vardo ir pavardės atnaujimas pagal id:</p>
          <input type="text" name="nrupd" value="">
          <input type="text" name="vardasupd" value="" placeholder="Vardas">
          <input type="text" name="pavardeupd" value="" placeholder="Pavardė">
