...
<html>
    ...
    <body>
        ...
        <h1> Isijunk Inspect-console (mokomes js) </h1>
          ...
          //reiksmes tikrinimas ar ji yra masyva
          //jei rado - grazina TRUE
          //         ieskomasis  masyvas(kurio viduje ieskoma)
          if (in_array('aaaaa', $_GET)) {

            echo "kazkucio stalciaus turinys yra:aaaaa";
          }

          //ar masyve egzistuoja stalcius pavadinimu "tekstas"
          if (array_key_exists('teksas', $_GET)) {
            $x = $_GET['tekstas']; //kintamogo, stalciaus pavadinimas
            echo "stalciaus tekstas egzituoja:" . $x;
          } else {
            echo "tekstas - tokio stalciaus nera" . "<br />";
          }
