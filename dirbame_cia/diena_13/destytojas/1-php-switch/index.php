...
<html>
    ...
    <body>
        ...
        $siandiena = trim($siandiena);  // ant password ir username
        echo "--$siandiena --";
        switch ($siandiena) {
            case 'pirmadienis':
                        echo "Tautvydai- siandien pirmadienis!! :D";
                        break;
            case 'antradienis':
                        echo "Tautvydai- siandien antradienis";
                        break;
            case 'treciadienis':
                        echo "Tautvydai- siandien treciadinis";
                        break;
            case 'ketvirtadienis':
                        echo "Tautvydai- siandien ketvirtadinis!";
                        break;
            case 'penktadienis':
