...
<html>
    ...
    <body>
        ...
        <?php
          ...
          // $siandiena = strtoupper($siandiena); //<--- pakeicia kad visas raides paverstu mazosiomis
          // $siandiena = trim($siandiena); //<-- padaro, kad nereaguotu i esancius tarpus tarp zodziu.
          ...
          switch ($siandiena) {
            ...
            case 'Antradienis':
              ...
              break;
            case 'Treciadienis':
              echo "Siandien Treciadienis!!";// code...
              break;
            case 'Ketvirtadienis':
              echo "Siandien Ketvirtadienis!!";// code...
              break;
            case 'Penktadienis':
              echo "Siandien Penktadienis!!";// code...
              break;
