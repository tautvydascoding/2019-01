    ...
    <body>
      ...
      <div class="container">
        <section class="row ">
                    <?php
                      $kaina = 49.99;
                       $antraste = "Labai labai labai gera preke";
                       $aprasymas = "Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua..";
