...
<html>
    ...
    <body>
      ...
      //  $siandiena = strtolower($siandiena); //ant username
        //$siandiena = trim($siandiena); //ant username ir password
        switch ($siandiena) {

              case 'pirmadienis':
                  echo "Vita, siandiena pirmadienis.";
                break;
              case 'antradienis':
                  echo "Vita, siandiena antradienis.";
                break;
              case 'treciadienis':
                  echo "Vita, siandiena treciadienis.";
                break;
              case 'Ketvirtadienis':
                  echo "Vita, siandiena ketvirtadienis.";
                break;
              case 'penktadienis':
                  echo "Vita, siandiena penktadienis.";
                break;
              case 'Sestadienis':
                  echo "Vita, siandiena Sestadienis.";
                break;
              case 'sekmadienis':
                  echo "Vita, siandiena sekmadienis, ilsekis.";
                break;
