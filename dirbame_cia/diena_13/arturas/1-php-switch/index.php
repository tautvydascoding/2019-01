...
<html>
    ...
    <body>
        ...
        switch ($siandiena) {
          case 'pirmadienis':
            echo "Siandien yra pirmadienis";
            break;
          case 'antradienis':
            echo "Siandien yra antradienis";
            break;
          case 'treciadienis':
            echo "Siandien yra treciadienis";
            break;
          case 'ketvirtadienis':
            echo "Siandien yra ketvirtadienis";
            break;
          case 'penktadienis':
            echo "Siandien yra penktadienis";
            break;
          default:
            echo "ilsimes";
            break;
