...
let masinos = ["auto1", "auto2", "auto3"];
auto1 = ["Audi", 2003, 2000, 300000];
auto2 = ["mazda", 2015, 9500, 100000];
auto3 = ["Tesla", 2019, 40000, 0];
...
masinos [2][3] = 1005;
masinos [2][0] = "Tesla 3.2";
masinos [0][2] = 2300;
 //arba
//masinos [0][2] = masinos [0][2]*1,1;
console.log("audi kaina:", masinos[0][2] );
console.log(masinos);
console.log("tesla pav keitimas:", masinos [2][0] );
...
//kitas budas:
for (var i = 0; i < visiDarbuotojai[0].length; i++) { // [0]-patikrina kiek pirmas darb turi parametru ir darom prielaida kad ir kiti darbuotojai tures tiek parametru
console.log(visiDarbuotojai[0][i]); // 0 - yra kelintas darbuotojas, i - paimam darbuotojo duonenis is kiekvieno stalciuko.
}
...
console.log("jauniausio numeris yra", jauniausioNr );
...
let VisosPrekes = [];
preke1 = ["Striuke", "imgDuonele", "Pukine", 190];
preke2 = ["Palaidine", "imgPalaidine", "Silkine", 60];
preke3 = ["Svarkas", "imgSvarkas", "Odinis", 110];
preke4 = ["Salikas", "imgSalikas", "Vilnonis", 50];
