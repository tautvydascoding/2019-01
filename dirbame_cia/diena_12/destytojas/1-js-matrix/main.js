...
let masinos = [];
//           pav     metai kaina  rida
let auto1 = ["Audi", 2003, 2000, 300000];
let auto2 = ["Mazda", 2015, 9500, 100000];
let auto3 = ["Tesla", 2019, 40000, 0];
let auto4 = ["Audi A2", 2010, 4000, 250000];

// idejimas // matricos kurimas
masinos[0] = auto1;
masinos[1] = auto2;
masinos[2] = auto3;
masinos[3] = auto4;

// Pakeitimas Teslos ridos i 1005 km
masinos[2][3] = 1003;

// duomenu isvedimas visu
// console.log(masinos);

// isvedimas visu automobiliu pavadinimu
for (var i = 0; i < masinos.length; i++) {
    console.log( "pavadinimas: ",  masinos[i][0] );
}
